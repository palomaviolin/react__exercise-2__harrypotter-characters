...
class App extends Component {
  ...
  render() {
    return (
      <Switch>
        <Route exact path="/" render={() => <Home filterCharacterData={this.filterCharacterData} data={this.state.filteredData}/> }/>
        <Route path="/characters/:id" render={(props) => <CharacterInfo characters={this.state.filteredData}  match={props.match} /> } />
      </Switch>
    );
  }
}
